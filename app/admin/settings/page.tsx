...
export default function AdminSettingsPage() {
  ...
  return (
    <div>
      <AdminHeader
        title="Settings & SMTP Mailer"
        description="Configure dynamic SMTP credentials for instant booking confirmations and company contact information."
      />
      ...
      <main className="p-8 max-w-5xl space-y-8">
        ...
        <form onSubmit={handleSaveSettings} className="space-y-8">
          ...
          <div className="glass-card rounded-3xl p-8 border border-gold/30 space-y-6 shadow-xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Connect your Gmail / Google Workspace, Office 365, or Custom SMTP server to send live receipts.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <Input
                  type="email"
                  placeholder="bookings@oracleprivatehire.co.uk"
              ...
              <div>
                ...
                <Input
                  type="password"
                  placeholder="App Password (16-char for Gmail)"
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <Input
                  placeholder='"Oracle Private Hire" <bookings@oracleprivatehire.co.uk>'
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-wider text-muted-foreground mb-1 font-medium">
                  Admin Notification Email (New Bookings/Inquiries)
                </label>
                <Input
                  type="email"
                  placeholder="bookings@oracleprivatehire.co.uk"
            ...
            <div className="p-5 rounded-2xl bg-[#0D0D0D] border border-white/5 space-y-3">
              <span className="text-xs font-semibold uppercase tracking-wider text-gold flex items-center gap-1.5">
                ...
                <span>Live SMTP Connection Test</span>
              </span>
              <p className="text-xs text-muted-foreground">
                Dispatch an immediate test email to verify your SMTP host, port, and authentication credentials.
              </p>
